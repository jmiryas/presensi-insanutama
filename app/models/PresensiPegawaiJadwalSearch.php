...
/**
 * app\models\PresensiPegawaiJadwalSearch represents the model behind the search form about `app\models\base\PresensiPegawaiJadwal`.
 */
 class PresensiPegawaiJadwalSearch extends PresensiPegawaiJadwal
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['jadwalpresensi_id', 'jenispegawai_id', 'jenispresensi', 'kode_hari', 'jadwal_masuk', 'jadwal_pulang', 'batas_awal_masuk', 'batas_akhir_masuk', 'batas_awal_pulang', 'batas_akhir_pulang', 'isaktif', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = PresensiPegawaiJadwal::find();
