...
/* @var $searchModel app\models\PresensiSiswaJenispresensiSearch */
...
$this->title = 'Presensi Siswa Jenispresensi';
...
?>
<div class="presensi-siswa-jenispresensi-index panel panel-default">
    ...
    <div class="d-flex justify-content-between mb-4">
        <div>
            <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/presensi-siswa-jenispresensi/create'], ['class' => 'btn btn-success']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-presensi-siswa-jenispresensi']],
