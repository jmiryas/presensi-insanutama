...
/* @var $searchModel app\models\PresensiPegawaiLogSearch */
...
$this->title = 'Presensi Pegawai Log';
...
?>
<div class="presensi-pegawai-log-index panel panel-default">
    ...
    $gridColumn = [
        ['class' => 'yii\grid\SerialColumn'],
            ...
            [
                ...
                'filterInputOptions' => ['placeholder' => 'Pegawai', 'id' => 'grid-presensi-pegawai-log-search-pegawai_id']
            ],
            'nokartu',
            'latitude',
            'longitude',
    ...
    <div class="d-flex justify-content-between mb-4">
        <div>
            <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/presensi-pegawai-log/create'], ['class' => 'btn btn-success']) ?>
