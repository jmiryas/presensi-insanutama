...
/* @var $searchModel app\models\PendidikanpegawaiSearch */
...
?>
<div class="pendidikanpegawai-index panel panel-default">
    <div class="panel-body">
        ...
        $gridColumn = [
            ...
            [
                'attribute' => 'jenjang',
                'filter' => ['SMP' => 'SMP', 'SMA' => 'SMA', 'D2' => 'D2', 'D3' => 'D3', 'S1' => 'S1', 'S2' => 'S2', 'S3' => 'S3', 'KEPROFESIAN LAIN' => 'KEPROFESIAN LAIN', 'PESANTREN' => 'PESANTREN',]
            ],
            [
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/pendidikanpegawai/create'], ['class' => 'btn btn-success']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => $gridColumn,
            'pjax' => true,
            'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-pendidikanpegawai']],
