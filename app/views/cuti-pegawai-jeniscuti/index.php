...
/* @var $searchModel app\models\CutiPegawaiJeniscutiSearch */
...
$this->title = 'Cuti Pegawai Jeniscuti';
...
?>
<div class="cuti-pegawai-jeniscuti-index panel panel-default">
    <div class="panel-body">
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/cuti-pegawai-jeniscuti/create'], ['class' => 'btn btn-success']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => $gridColumn,
            'pjax' => true,
            'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-cuti-pegawai-jeniscuti']],
