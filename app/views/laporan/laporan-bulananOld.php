            ...
            <table class="table table-striped table-hover table-borderless table-primary align-middle table-sm">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="bg-dangerx atext-light">Nis</th>
                        <th class="bg-dangerx atext-light">Nama</th>
                        <th class="bg-dangerx atext-light">Kelas</th>
                        <th class="bg-dangerx atext-light">TA</th>
                    ...
                    <?php else : ?>
                        ...
                        foreach ($datasiswa as $row) : ?>
                            <tr class="table-primary">
                                ...
                                <?php foreach ($label_tanggalan as $tanggal) : ?>
                                    <td><?= $datasebulan[$row['nis'] . '-' . $row['kodeta']][$tanggal]; ?></td>
                                <?php endforeach; ?>

                                <?php foreach ($label_jenispresensi as $presensi) : ?>
                                    <th><?= $datasumpresensi[$row['nis'] . '-' . $row['kodeta']][$presensi] ?? 0 ?></th>
                                <?php endforeach; ?>
                            </tr>
                    <?php endforeach;
                    endif ?>
