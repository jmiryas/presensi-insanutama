...
?>
<div class="hari-index panel panel-default">
    <div class="panel-body">
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                <?php // GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/hari/create'], ['class' => 'btn btn-success']) 
                ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => $gridColumn,
            'pjax' => true,
            'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-hari']],
