...
/* @var $searchModel app\models\PresensiSiswaJadwalSearch */
...
$this->title = 'Presensi Siswa Jadwal';
...
?>
<div class="presensi-siswa-jadwal-index panel panel-default">
    <div class="panel-body">
        ...
        $gridColumn = [
            ...
            [
                ...
                'filterInputOptions' => ['placeholder' => 'Hari', 'id' => 'grid-presensi-siswa-jadwal-search-kode_hari']
            ],
            'jadwal_masuk',
            'jadwal_pulang',
            'batas_awal_masuk',
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/presensi-siswa-jadwal/create'], ['class' => 'btn btn-success']) ?>
