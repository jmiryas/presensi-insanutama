...
/* @var $searchModel app\models\JenispegawaiSearch */
...
?>
<div class="jenispegawai-index panel panel-default">
    ...
    <div class="d-flex justify-content-between mb-4">
        <div>
            <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/jenispegawai/create'], ['class' => 'btn btn-success']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-jenispegawai']],
