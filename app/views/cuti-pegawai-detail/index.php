...
/* @var $searchModel app\models\CutiPegawaiDetailSearch */
...
$this->title = 'Cuti Pegawai Detail';
...
?>
<div class="cuti-pegawai-detail-index panel panel-default">
    ...
    $gridColumn = [
        ['class' => 'yii\grid\SerialColumn'],
            ...
            [
                ...
                'filterInputOptions' => ['placeholder' => 'Cuti pegawai data', 'id' => 'grid-cuti-pegawai-detail-search-cuti_id']
            ],
            'tgl_cuti',
            [
    ...
    <div class="d-flex justify-content-between mb-4">
        <div>
            <?= GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/cuti-pegawai-detail/create'], ['class' => 'btn btn-success']) ?>
