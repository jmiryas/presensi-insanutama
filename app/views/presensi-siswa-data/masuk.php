            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover table-borderless table-success align-middle table-sm">
                        ...
                        <tbody>
                            <?php if (empty($masukjadwal)) : ?>
                                <tr class="table-light">
                                    <td colspan="5" class="text-center"><i>Tidak ada jadwal.</i></td>
                                </tr>
                            <?php endif; ?>
                            <?php foreach ($masukjadwal as $key => $row) : ?>
                                <?php
                                if ($row['keterangan_masuk'] == 'Tepat') {
                                    $class = 'table-success';
                                } else if ($row['keterangan_masuk'] == 'Telat') {
                                    $class = 'table-danger';
                                } else if ($row['keterangan_masuk'] == 'Belum') {
                                    $class = 'table-warning';
                                }
                                ?>
                                <tr class="<?= $class ?>">
                                    ...
                                    <td><?= $row['batas_awal_masuk'] ?></td>
                                    <td><?= $row['batas_akhir_masuk'] ?></td>
