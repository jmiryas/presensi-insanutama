...
/* @var $searchModel app\models\PresensiSiswaLogSearch */
...
?>
<div class="presensi-siswa-log-index panel panel-default">
    <div class="panel-body">
        ...
        $gridColumn = [
            ...
            [
                ...
                'filterInputOptions' => ['placeholder' => 'Siswa', 'id' => 'grid-presensi-siswa-log-search-nis']
            ],
            'nokartu',
            // 'latitude',
            // 'longitude',
        ...
        <div class="d-flex justify-content-between mb-4">
            <div>
                <?php // GhostHtml::a('<span class=\'glyphicon glyphicon-plus-sign\'></span> Tambah', ['/presensi-siswa-log/create'], ['class' => 'btn btn-success']) 
                ?>
