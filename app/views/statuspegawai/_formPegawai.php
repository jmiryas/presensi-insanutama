...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'pendidikanpegawai_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\base\Pendidikanpegawai::find()->orderBy('pendidikanpegawai_id')->asArray()->all(), 'pendidikanpegawai_id', 'pendidikanpegawai_id'),
